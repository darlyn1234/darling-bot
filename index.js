...
let thumbfg2 = fs.readFileSync('./temp/fg2.jpg'); 
...
/**
// Anti spam que se suma al spam xd
...
switch (command) { 
 ...
 case 'help':
  ...
  ⎔ *${msg.lvl}* : ${isLevel}
  ⎔ *Premium* : ${prem}
  Solicitado por: https://wa.me/${sender.split('@')[0]}
  𝐇𝐨𝐥𝐚, 𝐚𝐡𝐢 𝐭𝐢𝐞𝐧𝐞𝐬 𝐞𝐥 𝐦𝐞𝐧𝐮 𝐜𝐡𝐢𝐬𝐭𝐨𝐬𝐨/𝐚

${readMore}
${menu(prefix)} 
`
    Fg.send3ButtonLoc(from, thumbfg, capt, `▢ 𝔫𝔬𝔱𝔥𝔦𝔫𝔤 𝔦𝔰 𝔟𝔞𝔡 𝔦𝔣 𝔦𝔱 𝔦𝔰 𝔡𝔬𝔫𝔢 𝔴𝔦𝔱𝔥 𝔩𝔬𝔳𝔢*\n▢ 𝔪𝔞𝔯𝔦𝔠𝔬𝔫 𝔠𝔲𝔩𝔦𝔞𝔬\n▢ *Total Hits* : ${isTotalcmd}\n▢ *Usuarios* : ${User.length}\n▢ *Runtime* : ${kyun(process.uptime())}\n\n𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, `⦙☰ Menu Vc`, `${prefix}menuvc`, '✆ Owner', `${prefix}owner`, '⏍ Info', `${prefix}info`)
    break
    
    case 'menuvc': 
 case 'helpvc':
    capt = `────  *८≛𝓓𝓪𝓻𝓵𝔂𝓷𔐬☆᤻᤻[𝓼𝓮𝔁]*  ────
...
${menuVC} 
`
    Fg.send3ButtonLoc(from, thumbfg2, capt, `⎙ 𝔫𝔬𝔱𝔥𝔦𝔫𝔤 𝔦𝔰 𝔟𝔞𝔡 𝔦𝔣 𝔦𝔱 𝔦𝔰 𝔡𝔬𝔫𝔢 𝔴𝔦𝔱𝔥 𝔩𝔬𝔳𝔢*\n⎙ 𝔪𝔞𝔯𝔦𝔠𝔬𝔫 𝔠𝔲𝔩𝔦𝔞𝔬\n⎙ *Total Hits* : ${isTotalcmd}\n⎙ *Usuarios* : ${User.length}\n⎙ *Runtime* : ${kyun(process.uptime())}\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬 ☆᤻᤻ [𝓼𝓮𝔁]\n𝑆𝑜𝑓𝑓𝑓`, '✆ Owner', `${prefix}owner`, '⏍ Info', `${prefix}info`, `⌬ ${msg.gp}s`, `${prefix}grupos`)
    break 
...
case 'donate':
case 'donar':
 m.reply('Maricon culiao') 
break

/*case 'ownerig':
case 'darlynig':
 m.reply('https"//instagram.com/darling_zbig') 
break*/
...
case 'creador': 
case 'developer':
number = '51918303426@s.whatsapp.net'
    capt = `⎙ ${msg.num} : @${number.split('@')[0]}\n\n`
    capt += '⎙ IG : https://www.instagram.com/'
    await Fg.fakeLink(from, capt, thumbfg, `${msg.click}`, 'https://www.instagram.com/', mek)
   Fg.sendContact(from, '51918303426', '८ 📺 🍂≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬 ☆᤻᤻ [𝓼𝓮𝔁]', mek) 
    break
...
*≡ OWNER*
⎙ WhatsApp : https://wa.me/51918303426
⎙ WhatsApp2: https://wa.me/51956570030
Numero del bot: https://wa.me/5192513366

` 
Fg.send2Button(from, teks, '𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]', `𝑆𝑜𝑓𝑓𝑓`, `${prefix}donate`, `८≛𝓓𝓪𝓻𝓵𝔂𝓷𔐬☆᤻᤻[𝓼𝓮𝔁]`, `${prefix}grupos`)
   break
 ...
 if(!value) return m.reply(msg.notext)
  ...
  case 'reto':
    ...
    Fg.send2Button(from, capt, `𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, `VERDAD`, `${prefix}verdad`, `RETO`, `${prefix}reto`)
    break
...
────────────────\n`;
 ...
 img = await (await fetch('https://telegra.ph/file/243fdf9fd2748b4750a80.jpg')).buffer()
   music = `≡ *𝑀𝒰𝒮𝐼𝒞*
┌──────────────
...
└──────────────` 
 Fg.send2ButtonLoc(from, img, music, `${msg.pfo} *${prefix}play2*\n\𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, '🎶 MP3', `${prefix}fgmp3 ${linkp[0].url}`, '🎥 MP4', `${prefix}fgmp4 ${linkp[0].url}`)
 break
 ...
 img = await (await fetch('https://telegra.ph/file/50210b42bdc701ce62545.jpg')).buffer()
   music = `≡ *𝑷𝑳𝑨𝒀 𝑴𝑼𝑺𝑰𝑪*
...
└──────────────` 
 Fg.send3ButtonLoc(from, img, music, `${msg.pafo}\n\𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, '⎙ Music 1', `${prefix}fgmp3 ${link[0].url}`, '⎙ Music 2', `${prefix}fgmp3 ${link[1].url}`, '⎙ Music 3', `${prefix}fgmp3 ${link[2].url}`)
 break
 ...
 case 'playvideo': 
   ...
   if(!link) return ('Error')
 // img = await getBuffer(link[0].image)
 img = await (await fetch('https://telegra.ph/file/f10eec03d242282d8d13e.jpg')).buffer()
   music = `≡ *𝑷𝑳𝑨𝒀 𝑽𝑰𝑫𝑬𝑶*
...
▢ *${msg.timp}* : ${link[2].timestamp}
└──────────────` 
 Fg.send3ButtonLoc(from, img, music, `${'selecciona el video que deseas descargar\n\𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]'}`, '⎙ Video 1', `${prefix}fgmp4 ${link[0].url}`, '⎙ Video 2', `${prefix}fgmp4 ${link[1].url}`, '⎙ Video 3', `${prefix}fgmp4 ${link[2].url}`)
 break
...
if(!isGroup) return m.reply(msg.group)
    if(!isBotAdmins) return m.reply(msg.botadmin)
    if(!isAdmins && !isOwner) return m.reply(msg.admin)
//if (args.length < 1) return reply(`Para abrir grupo : *${prefix + command}* open\npara cerrar grupo : *${prefix + command}* close`)
if (args[0] === 'open') {
 m.reply(msg.open)
...
Fg.sendMessage(from, prof, image, { thumbnail: fakethumb, quoted: mek, caption: perfil})
   ...
   try {
	      ...
	      ppimg = 'https://telegra.ph/file/243fdf9fd2748b4750a80.jpg';
	    }
...
❌ : *${msg.vno}*`
    Fg.vote[from] = [
        await Fg.send2Button(from, caption, `𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, '✅', `${prefix}yes`, '❌', `${prefix}no`, false, { contextInfo:{
...
❌ : ${devote.length} *Total*
${listDevote}`.trim()
    await Fg.send3Button(from, caption, `𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]'`, '✅', `${prefix}yes`, '❌', `${prefix}no`, `📈 ${msg.vrvt}`, `${prefix}checkvote`, false, { contextInfo: { mentionedJid: Fg.parseMention(caption) } })
    break
...
❌ : ${devote.length} *Total*
${listDevote}`.trim()
    await Fg.sendButton(from, caption, `𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, `🚫 ${msg.dlte}`, `${prefix}delvote`, false, { contextInfo: { mentionedJid: Fg.parseMention(caption) } })
break
...
case 'prefijo':
   ...
   if((args[0]) == 'multi'){
      ...
      m.reply(`${msg.setponepre} *${Use.prefix}*`)
    	...
    	Fg.send3Button(from, `✳️ ${msg.setpall}\n\n• *multi* _${msg.setpmt}_\n• *nopref* _${msg.setpnp}_ \n• *onepref* _${msg.setpop}_`, `${'𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]'}`, `${msg.setpop}`, `${prefix + command} onepref`, `${msg.setpnp}`, `${prefix + command} nopref`, `${msg.setpmt}`, `${prefix + command} multi`)
   } 
    break
    ...
    case 'actualizar':
if (!isOwner && !isBot) return m.reply(msg.owner)
//gfg = `git remote set-url origin https://github.com/darlyn1234/cofi-bot.git && git pull `
...
case 'delwelcome':
 ...
 case 'simular':
   ...
   try {
	      ...
	      ppimg = 'https://telegra.ph/file/50210b42bdc701ce62545.jpg';
	    }
...
Fg.send2ButtonLoc(from, welm, capt, '८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬 ☆᤻᤻ [𝓼𝓮𝔁]\n𝑆𝑜𝑓𝑓𝑓', '⦙☰ MENU', '/menu', '⏍ INFO GP', '/infogp', false, {
	      contextInfo: { 
            mentionedJid: Fg.parseMention(capt)
	      } 
	    }); //--
  ...
  //Fg.sendMessage(from, welm, image, {contextInfo: {  mentionedJid: [sender]}, thumbnail: fakethumb, quoted: mek, caption: capt})
   Fg.sendButtonLoc(from, welm, capt, '𝓢𝓸𝓯í𝓪\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]', 'Hasta pronto xd', 'unde', false, {
	      contextInfo: { 
            mentionedJid: Fg.parseMention(capt)
	      } 
	    });//---
...
`
  ...
  case 'google':
   ...
   await Fg.adReply(from, msg, text, 'BÚSQUEDA DE GOOGLE : ' + value, tanggal, thumbfg2, linkIg)
   break
